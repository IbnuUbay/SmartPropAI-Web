...
const PropertyCard = ({ property }) => {
  const getRateDisplay = () => {
    ...
    if (rates.monthly) {
      return `${rates.monthly.toLocaleString()}/bulan`;
    } else if (rates.weekly) {
      return `${rates.weekly.toLocaleString()}/minggu`;
    } else if (rates.nightly) {
      return `${rates.nightly.toLocaleString()}/malam`;
    }
  };
      ...
      <div className='p-4'>
        ...
        <div className='flex justify-center gap-4 text-gray-500 mb-4'>
          ...
          <p>
            ...
            {property.baths} <span className='md:hidden lg:inline'>Kamar Mandi</span>
          </p>
          <p>
